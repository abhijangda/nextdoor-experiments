...
parser.add_argument("--graph_dir",default=None,help="Absolute path of directory where graphs are stored")
parser.add_argument("--dataset",required=True,type=str,help="identifying training data (ppi|livejournal|reddit|orkut)")

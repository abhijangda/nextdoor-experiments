python main_experiments.py --dataset ppi --batch_size 256 --samp_num 256 --cuda $1 --is_ratio 1.0 --batch_num 20 --n_stops 1000 --show_grad_norm 1 --n_layers $2 > logs/train_log_ppi_256_$2.txt
